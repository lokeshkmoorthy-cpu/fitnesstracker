...
export const StatCard: React.FC<StatCardProps> = ({ label, value, icon, subtitle, trend }) => {
  return (
    <div className="bg-white dark:bg-slate-900 rounded-2xl p-3 shadow-premium border border-slate-50 dark:border-white/5 flex flex-col justify-between hover:shadow-card-hover transition-all group overflow-hidden relative">
