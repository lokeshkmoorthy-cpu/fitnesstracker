...
export const GoalProgressCard: React.FC<GoalProgressCardProps> = ({ current, total, label, onSetGoalClick }) => {
  ...
  return (
    <div className="bg-white dark:bg-slate-900 rounded-3xl p-8 shadow-premium border border-slate-50 dark:border-white/5 flex flex-col h-full hover:shadow-card-hover transition-all group">
