...
export const FilterPanel: React.FC<FilterPanelProps> = ({
  ...
  return (
    <motion.div
      ...
      className="bg-white border border-slate-50 rounded-3xl p-6 shadow-premium"
    >
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex items-center gap-4">
          ...
          <button
            onClick={onClear}
            className="text-[10px] font-bold uppercase tracking-[0.18em] text-slate-400 hover:text-slate-900 transition-colors flex items-center gap-1.5"
          >
            <X className="w-3 h-3" />
            Clear
          </button>
